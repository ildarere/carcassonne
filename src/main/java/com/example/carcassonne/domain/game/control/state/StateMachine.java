...
public class StateMachine {
     ...
     */
    public StateMachine(GameSettings settings) {

        stateMap = new HashMap<>();
        currentState = new StateIdle(this, settings);
        registerState(currentState);
        registerState(new StateManning(this, settings));
        registerState(new StatePlacing(this, settings));
        registerState(new StateGameOver(this, settings));
    }
