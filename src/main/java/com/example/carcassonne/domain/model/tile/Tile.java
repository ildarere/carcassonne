...
import com.example.carcassonne.domain.model.grid.*;
...
import com.example.carcassonne.domain.model.terrain.TileTerrain;
...
public class Tile {
    ...
    public Tile(TileType type,TileRotation rotation ) {
        if (type == null) {
            throw new IllegalArgumentException("Tile type cannot be null");
        }
        this.type = type;
    ...
    public String getInf(){
        return  type + "%"+ gridSpot.getX()+"%"+ gridSpot.getY()+"%"+ getRotation();
    }
